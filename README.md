...
## Опис
**MVP** - це модель проєктування архітектури програмного забезпечення, яка вперше була представлена у 1990-х роках. Цей шаблон схожий на архітектуру **MVC**, але **Presenter** замінює **Controller**. **Presenter** несе відповідальність за зв'язок даних між **Model** та **Presenter**. Нижче наведено ілюстрацію того, як **Model** і **View** передають дані через **Presenter**.
